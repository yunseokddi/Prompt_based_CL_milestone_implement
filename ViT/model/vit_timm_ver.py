...
def vit_huge_patch14_224_ijepa(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer('vit_huge_patch14_224_ijepa', pretrained=pretrained,
...
def vit_huge_patch16_448_ijepa(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model_args = dict(patch_size=16, embed_dim=1280, depth=32, num_heads=16, class_token=False, global_pool='avg',
                      img_size=448)
    model = _create_vision_transformer('vit_huge_patch16_448_ijepa', pretrained=pretrained,
                                       **dict(model_args, **kwargs))
    return model
